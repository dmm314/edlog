...
--
-- Seeds:
--   1. 10 Cameroon regions + all 58 divisions (complete)
--   2. 10 regional admin accounts (one per region)
--   3. 1 demo school + admin + 2 teachers (for testing)
--
-- Schools register themselves via the app using registration
-- codes generated by regional admins. Subjects, classes,
-- timetables, and curriculum data are created per-school.
-- ============================================================
...
--    All 58 divisions (départements) included.
-- ============================================================
...
INSERT INTO "Division" ("id", "name", "regionId") VALUES
  ('div_ad_1', 'Djerem',       'reg_ad'),
  ('div_ad_2', 'Faro-et-Deo',  'reg_ad'),
  ('div_ad_3', 'Mayo-Banyo',   'reg_ad'),
  ('div_ad_4', 'Mbere',        'reg_ad'),
...
INSERT INTO "Region" ("id", "name", "code", "capital") VALUES ('reg_ce', 'Centre', 'CE', 'Yaounde')
  ON CONFLICT ("id") DO NOTHING;
INSERT INTO "Division" ("id", "name", "regionId") VALUES
  ('div_ce_1',  'Haute-Sanaga',     'reg_ce'),
  ('div_ce_2',  'Lekie',            'reg_ce'),
  ('div_ce_3',  'Mbam-et-Inoubou',  'reg_ce'),
  ('div_ce_4',  'Mbam-et-Kim',      'reg_ce'),
  ('div_ce_5',  'Mefou-et-Afamba',  'reg_ce'),
  ('div_ce_6',  'Mefou-et-Akono',   'reg_ce'),
  ('div_ce_7',  'Mfoundi',          'reg_ce'),
  ('div_ce_8',  'Nyong-et-Kelle',   'reg_ce'),
  ('div_ce_9',  'Nyong-et-Mfoumou', 'reg_ce'),
  ('div_ce_10', 'Nyong-et-Soo',     'reg_ce')
  ON CONFLICT ("id") DO NOTHING;
...
INSERT INTO "Region" ("id", "name", "code", "capital") VALUES ('reg_es', 'East', 'ES', 'Bertoua')
  ON CONFLICT ("id") DO NOTHING;
INSERT INTO "Division" ("id", "name", "regionId") VALUES
  ('div_es_1', 'Boumba-et-Ngoko', 'reg_es'),
  ('div_es_2', 'Haut-Nyong',      'reg_es'),
  ('div_es_3', 'Kadey',           'reg_es'),
  ('div_es_4', 'Lom-et-Djerem',   'reg_es')
  ON CONFLICT ("id") DO NOTHING;

-- Far North (6 divisions)
INSERT INTO "Region" ("id", "name", "code", "capital") VALUES ('reg_fn', 'Far North', 'FN', 'Maroua')
  ON CONFLICT ("id") DO NOTHING;
INSERT INTO "Division" ("id", "name", "regionId") VALUES
  ('div_fn_1', 'Diamare',          'reg_fn'),
  ('div_fn_2', 'Logone-et-Chari',  'reg_fn'),
  ('div_fn_3', 'Mayo-Danay',       'reg_fn'),
  ('div_fn_4', 'Mayo-Kani',        'reg_fn'),
  ('div_fn_5', 'Mayo-Sava',        'reg_fn'),
  ('div_fn_6', 'Mayo-Tsanaga',     'reg_fn')
  ON CONFLICT ("id") DO NOTHING;

-- Littoral (4 divisions)
INSERT INTO "Region" ("id", "name", "code", "capital") VALUES ('reg_lt', 'Littoral', 'LT', 'Douala')
  ON CONFLICT ("id") DO NOTHING;
INSERT INTO "Division" ("id", "name", "regionId") VALUES
  ('div_lt_1', 'Moungo',           'reg_lt'),
  ('div_lt_2', 'Nkam',             'reg_lt'),
  ('div_lt_3', 'Sanaga-Maritime',  'reg_lt'),
  ('div_lt_4', 'Wouri',            'reg_lt')
  ON CONFLICT ("id") DO NOTHING;
...
INSERT INTO "Region" ("id", "name", "code", "capital") VALUES ('reg_no', 'North', 'NO', 'Garoua')
  ON CONFLICT ("id") DO NOTHING;
INSERT INTO "Division" ("id", "name", "regionId") VALUES
  ('div_no_1', 'Benoue',     'reg_no'),
  ('div_no_2', 'Faro',       'reg_no'),
  ('div_no_3', 'Mayo-Louti', 'reg_no'),
  ('div_no_4', 'Mayo-Rey',   'reg_no')
  ON CONFLICT ("id") DO NOTHING;

-- Northwest (7 divisions)
INSERT INTO "Region" ("id", "name", "code", "capital") VALUES ('reg_nw', 'Northwest', 'NW', 'Bamenda')
  ON CONFLICT ("id") DO NOTHING;
INSERT INTO "Division" ("id", "name", "regionId") VALUES
  ('div_nw_1', 'Boyo',           'reg_nw'),
  ('div_nw_2', 'Bui',            'reg_nw'),
  ('div_nw_3', 'Donga-Mantung',  'reg_nw'),
  ('div_nw_4', 'Menchum',        'reg_nw'),
  ('div_nw_5', 'Mezam',          'reg_nw'),
  ('div_nw_6', 'Momo',           'reg_nw'),
...
INSERT INTO "Region" ("id", "name", "code", "capital") VALUES ('reg_su', 'South', 'SU', 'Ebolowa')
  ON CONFLICT ("id") DO NOTHING;
INSERT INTO "Division" ("id", "name", "regionId") VALUES
  ('div_su_1', 'Dja-et-Lobo',    'reg_su'),
  ('div_su_2', 'Mvila',           'reg_su'),
  ('div_su_3', 'Ocean',           'reg_su'),
  ('div_su_4', 'Vallee-du-Ntem',  'reg_su')
  ON CONFLICT ("id") DO NOTHING;

-- Southwest (6 divisions)
INSERT INTO "Region" ("id", "name", "code", "capital") VALUES ('reg_sw', 'Southwest', 'SW', 'Buea')
  ON CONFLICT ("id") DO NOTHING;
INSERT INTO "Division" ("id", "name", "regionId") VALUES
  ('div_sw_1', 'Fako',              'reg_sw'),
  ('div_sw_2', 'Koupe-Manengouba',  'reg_sw'),
  ('div_sw_3', 'Lebialem',          'reg_sw'),
  ('div_sw_4', 'Manyu',             'reg_sw'),
  ('div_sw_5', 'Meme',              'reg_sw'),
  ('div_sw_6', 'Ndian',             'reg_sw')
  ON CONFLICT ("id") DO NOTHING;
...
INSERT INTO "Region" ("id", "name", "code", "capital") VALUES ('reg_ou', 'West', 'OU', 'Bafoussam')
  ON CONFLICT ("id") DO NOTHING;
INSERT INTO "Division" ("id", "name", "regionId") VALUES
  ('div_ou_1', 'Bamboutos',      'reg_ou'),
  ('div_ou_2', 'Haut-Nkam',      'reg_ou'),
  ('div_ou_3', 'Hauts-Plateaux',  'reg_ou'),
  ('div_ou_4', 'Koung-Khi',      'reg_ou'),
  ('div_ou_5', 'Menoua',         'reg_ou'),
  ('div_ou_6', 'Mifi',           'reg_ou'),
  ('div_ou_7', 'Nde',            'reg_ou'),
  ('div_ou_8', 'Noun',           'reg_ou')
  ON CONFLICT ("id") DO NOTHING;
...
--
--   10 regions, 58 divisions (all of Cameroon)
--   ├─ Adamawa (5): Djerem, Faro-et-Deo, Mayo-Banyo, Mbere, Vina
--   ├─ Centre (10): Haute-Sanaga, Lekie, Mbam-et-Inoubou, Mbam-et-Kim,
--   │    Mefou-et-Afamba, Mefou-et-Akono, Mfoundi, Nyong-et-Kelle,
--   │    Nyong-et-Mfoumou, Nyong-et-Soo
--   ├─ East (4): Boumba-et-Ngoko, Haut-Nyong, Kadey, Lom-et-Djerem
--   ├─ Far North (6): Diamare, Logone-et-Chari, Mayo-Danay, Mayo-Kani,
--   │    Mayo-Sava, Mayo-Tsanaga
--   ├─ Littoral (4): Moungo, Nkam, Sanaga-Maritime, Wouri
--   ├─ North (4): Benoue, Faro, Mayo-Louti, Mayo-Rey
--   ├─ Northwest (7): Boyo, Bui, Donga-Mantung, Menchum, Mezam, Momo,
--   │    Ngo-Ketunjia
--   ├─ South (4): Dja-et-Lobo, Mvila, Ocean, Vallee-du-Ntem
--   ├─ Southwest (6): Fako, Koupe-Manengouba, Lebialem, Manyu, Meme, Ndian
--   └─ West (8): Bamboutos, Haut-Nkam, Hauts-Plateaux, Koung-Khi, Menoua,
--        Mifi, Nde, Noun
--
--   10 regional admin accounts (password: Edlog2026!)
--     adamawa@edlog.cm    | centre@edlog.cm     | east@edlog.cm
--     farnorth@edlog.cm   | littoral@edlog.cm   | north@edlog.cm
--     northwest@edlog.cm  | south@edlog.cm      | southwest@edlog.cm
--     west@edlog.cm
--
--   Demo accounts (password: Edlog2026!)
--     admin@edlog.cm   (School Admin - Lycee Bilingue de Buea)
--     darren@edlog.cm  (Teacher)
--     brayan@edlog.cm  (Teacher)
--
-- Schools register via the app using codes from regional admins.
-- ============================================================
