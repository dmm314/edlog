...
function TeacherActivityRow({
  ...
  const avatarBg = rate >= 90 ? "#DCFCE7" : rate >= 70 ? "#FEF3C7" : "#FEE2E2";
  const avatarText = rate >= 90 ? "#16A34A" : rate >= 70 ? "#D97706" : "#DC2626";
  const countColor = rate >= 90 ? "#16A34A" : rate >= 70 ? "#D97706" : "#DC2626";
