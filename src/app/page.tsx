    ...
    <div className="min-h-screen bg-[var(--bg-primary)] overflow-hidden">
        ...
        <div className="relative px-5 pt-14 pb-20 max-w-lg mx-auto">
          ...
          <div className="space-y-5">
            ...
            <div className="flex gap-3 pt-2">
              <Link
                href="/login"
                className="flex-1 flex items-center justify-center gap-2 bg-white text-slate-900 font-bold rounded-xl py-3.5 px-5 text-sm hover:bg-slate-100 active:scale-[0.98] transition-all"
              >
                Sign In
        ...
        <div className="space-y-6">
          {[
            ...
            <div key={n} className="flex gap-4">
              <div className="flex-shrink-0 w-10 h-10 rounded-2xl flex items-center justify-center text-white font-bold text-sm"
      ...
      <div className="page-header px-5 py-14">
        <div className="max-w-lg mx-auto text-center relative">
          ...
          <div className="flex flex-col gap-3 mt-8 max-w-xs mx-auto">
            <Link
              href="/register"
              className="flex items-center justify-center gap-2 bg-white text-slate-900 font-bold rounded-xl py-3.5 px-6 text-sm hover:bg-slate-100 active:scale-[0.98] transition-all"
            >
              Create Free Account
              <ArrowRight className="w-4 h-4" />
            </Link>
      ...
      <div className="px-5 py-8 text-center" style={{ backgroundColor: "var(--bg-secondary)", borderTop: "1px solid var(--border-primary)" }}>
        <div className="flex items-center justify-center gap-2 mb-3">
          <div className="w-6 h-6 rounded-lg flex items-center justify-center" style={{ backgroundColor: "var(--accent-light)" }}>
            <BookOpen className="w-3.5 h-3.5 text-[var(--accent-text)]" />
          </div>
          <span className="text-[var(--text-tertiary)] font-semibold text-sm">Edlog</span>
        </div>
