...
export default function CoordinatorActivityReportPage() {
  ...
  return (
    <>
      <DataTable<ActivityRow>
        columns={columns}
        endpoint="/api/coordinator/reports/activity"
        title="Teaching Activity"
        description="All logbook entries at your assigned level(s). Click a row to view the full entry."
        searchPlaceholder="Search by teacher, module, or topic..."
        defaultSort="date"
        defaultOrder="desc"
        exportFilename="coordinator-activity-report"
