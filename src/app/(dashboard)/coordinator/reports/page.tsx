      ...
      <div className="px-5 mt-4 max-w-lg mx-auto space-y-3">
        ...
        <div className="flex gap-2">
          ...
          >
            ...
            {hasActiveFilters && (
              <span className="absolute -top-1 -right-1 w-3 h-3 rounded-full text-white flex items-center justify-center" style={{ background: "#7C3AED", fontSize: "8px" }}>
                ●
              </span>
            )}
          </button>
          ...
          <div className="card p-4 space-y-3 animate-fade-in">
            ...
            <div className="grid grid-cols-2 gap-2">
              <div>
                ...
                <select
                  value={filterTeacher}
                  onChange={(e) => { setFilterTeacher(e.target.value); setOffset(0); }}
              ...
              <div>
                ...
                <select
                  value={filterClass}
                  onChange={(e) => { setFilterClass(e.target.value); setOffset(0); }}
                  className="input-field text-sm"
                >
                ...
                <Link
                  ...
                  style={{
                    borderLeft: entry.status === "SUBMITTED" ? "3px solid #7C3AED" :
                      ...
                      entry.status === "FLAGGED" ? "3px solid #DC2626" : "3px solid var(--border-secondary)",
                  }}
                >
                  <div
