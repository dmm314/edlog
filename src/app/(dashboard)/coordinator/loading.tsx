    ...
    <div className="min-h-screen bg-[hsl(var(--surface-canvas))]">
      <div className="page-shell px-5 pt-6 space-y-6">
        ...
        <div className="flex items-center gap-3 animate-pulse">
          ...
          <div className="h-7 w-52 rounded bg-[var(--skeleton-base)]" />
        </div>
        ...
        <div className="animate-pulse space-y-3">
          <div className="h-5 w-32 rounded bg-[var(--skeleton-base)]" />
          <div className="h-24 w-full rounded-xl bg-[var(--skeleton-base)]" />
          <div className="h-24 w-full rounded-xl bg-[var(--skeleton-base)]" />
        </div>
      </div>
    </div>
