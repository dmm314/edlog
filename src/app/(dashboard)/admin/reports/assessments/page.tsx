...
export default function AdminAssessmentsReportPage() {
  return (
    <DataTable<AssessmentRow>
      columns={columns}
      endpoint="/api/admin/reports/assessments"
      title="Assessments"
      description="All tests and exams logged by teachers."
      searchPlaceholder="Search by teacher or title..."
      defaultSort="date"
      defaultOrder="desc"
      exportFilename="assessments-report"
