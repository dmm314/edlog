    ...
    <div className="min-h-screen bg-slate-50 pb-24">
      ...
      <div className="bg-gradient-to-br from-brand-950 to-brand-800 px-5 pt-10 pb-6 rounded-b-2xl">
        <div className="max-w-lg mx-auto">
          ...
          <h1 className="text-xl font-bold text-white">Manage Subjects</h1>
          <p className="text-brand-400 text-sm mt-0.5">
            {linkedCount} subject{linkedCount !== 1 ? "s" : ""} added to your
            school
          </p>
        </div>
      </div>
      ...
      <div className="px-5 mt-4 max-w-lg mx-auto space-y-4">
        ...
        <div className="card p-4">
          <p className="text-sm text-slate-600">
            Select the subjects taught at your school. These will be available
